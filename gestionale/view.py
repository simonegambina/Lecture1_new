...
class View:
    def __init__(self, page):
        ...
        # self._page.update() -- questo va fatto ogni volta che modifichi qualcosa. Oppure ti crei un metodo (vedi in basso)
        self.update_page()
    ...
    def carica_interfaccia(self):
        ...
        self._txtInMail = ft.TextField(label = "E-mail", width=200)
        ...
        self._btnGestisciAllOrdini = ft.ElevatedButton(text = "Gestitsci tutti gli ordini",
